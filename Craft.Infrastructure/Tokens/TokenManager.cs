...
public class TokenManager(IOptions<JwtSettings> options) : ITokenManager
{
    ...
    public AuthResponse GenerateJwtTokens(IEnumerable<Claim> claims)
    {
        return new AuthResponse(GenerateTokens(claims),
    ...
    public string GenerateTokens(IEnumerable<Claim> claims)
    {
        ...
        var token = new JwtSecurityToken(
                    ...
                    audience: jwtSettings.ValidAudiences.FirstOrDefault(),
                    claims: claims,
