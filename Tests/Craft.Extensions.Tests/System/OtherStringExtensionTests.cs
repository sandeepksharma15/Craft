...
public class OtherStringExtensionTests
{
    ...
    [InlineData(null, new string[] { "abc" }, null, null)]
    [InlineData("source", new string[] { }, "source", "source")]
    [InlineData("apple,orange,apple,banana", new string[] { "apple", "banana" }, ",orange,,", "Remove specific strings")]
    [InlineData("abcdef", new string[] { "abc", "def" }, "", "Remove all occurrences")]
    [InlineData("", new string[] { "abc" }, "", "Empty source string")]
    public void RemoveAll_ShouldRemoveStringsCorrectly(string source, string[] stringsToRemove, string expectedResult, string testCase)
    {
        // Act
